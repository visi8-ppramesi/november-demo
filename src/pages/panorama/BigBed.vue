<template>
    <marzipano 
        sceneUrl="/assets/scenes/BigBed_BLANK.jpg"
        :arrows="arrows"
    />
    <!-- <div class="container">
...
export default {
    ...
    //     this.marzObj = createMarzipano(elem, '/assets/scenes/BigBed_BLANK.jpg')
            ...
            arrows: [
                {
                    ...
                    title: 'Room view',
                    coord: {
                        yaw: -0.2528655299637341, pitch: -0.0051562669296624
                    }
                },
            ],
        }
