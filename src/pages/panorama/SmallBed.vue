<template>
    <marzipano 
        sceneUrl="/assets/scenes/SmallBed_BLANK.jpg"
        :arrows="arrows"
    />
    <!-- <div class="container">
...
export default {
    ...
    //     this.marzObj = createMarzipano(elem, '/assets/scenes/SmallBed_BLANK.jpg')
    ...
    data(){
        return {
            ...
            // },
            // coords: {
            //     arrowOne: {yaw: 0.16908380050844762, pitch: -0.006985822411445852}
            // }
            arrows: [
                {
                    name: 'arrowOne',
                    ...
                    title: 'Room view',
                    coord: {
                        yaw: 0.16908380050844762, pitch: -0.006985822411445852
                    }
                },
            ],
        }
